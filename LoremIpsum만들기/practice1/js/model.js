...
const generateParagraph = function (num) {
  state.curParagraph = [...new Array(num)].map(para => {
    return state.dummyTexts[randomNumber(0, state.dummyTexts.length - 1)];
  })
}

export { state, generateParagraph }