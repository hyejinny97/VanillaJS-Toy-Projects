...
const updateCurReview = function (idx) {
  state.curReview = { idx, ...state.reviews[idx] };
}

const updateCurReviewRandom = function () {
  const idx = randomNumber(0, state.reviews.length - 1);
  updateCurReview(idx);
}
...
export { state, updateCurReview, updateCurReviewRandom }